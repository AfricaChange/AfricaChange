...
class Config:
    ...
    SENEPAY_MODE = os.getenv("SENEPAY_MODE", "sandbox")
    SENEPAY_BASE_URL = os.getenv("SENEPAY_BASE_URL", "https://api.sene-pay.com")
    SENEPAY_PUBLIC_KEY = os.getenv("SENEPAY_PUBLIC_KEY")
    SENEPAY_SECRET_KEY = os.getenv("SENEPAY_SECRET_KEY")
    SENEPAY_WEBHOOK_SECRET = os.getenv("SENEPAY_WEBHOOK_SECRET")
    AFRICACHANGEX_CUSTOM_CA_BUNDLE = os.getenv("AFRICACHANGEX_CUSTOM_CA_BUNDLE")
